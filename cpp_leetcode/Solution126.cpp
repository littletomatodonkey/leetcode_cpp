...
// 使用DFS与BFS都会超时，最后使用two-end BFS
// 参考链接：https://leetcode.com/problems/word-ladder-ii/discuss/40540/88ms!-Accepted-c++-solution-with-two-end-BFS.-68ms-for-Word-Ladder-and-88ms-for-Word-Ladder-II
class Solution126 {
public:
...
int main()
{
	...
	vector<vector<string>> ret = s.findLadders( "hit", "cog", words );
	//vector<int> ret;
	cout << endl;
	system("pause");
	return 0;
